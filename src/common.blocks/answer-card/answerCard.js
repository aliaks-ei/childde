(function () {
  const bestAnswerLabelActivators = document.querySelectorAll(
    '[data-toggle="bestAnswerLabel"]'
  );
  ...
  function setAnswerAsTheBest() {
    ...
    const bestAnswerLabelEl = answerCardEl.querySelector(
      ".answer-card__best-answer-label"
    );
