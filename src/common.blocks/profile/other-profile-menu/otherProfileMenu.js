(function () {
  const otherProfileMenuActivator = document.querySelector(
    '[data-target="otherProfileMenu"]'
  );
  ...
  window.addEventListener("click", function (event) {
    ...
    if (
      otherProfileMenuActivator.contains(event.target) ||
      otherProfileMenu.contains(event.target)
    ) {
