(function () {
	const updateProfileCoverActivator = document.querySelector('[data-target="profileUpdateCover"]');
	const updateProfileCoverCloseBtn  = document.querySelector('[data-target-close="profileUpdateCover"]');
