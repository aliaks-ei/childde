let qNotificationsToggler = document.querySelectorAll(
  '[data-target="qNotificationsToggler"]'
);
...
for (let toggler of qNotificationsToggler) {
  toggler.addEventListener("click", function () {
    ...
    const bellCrossedIcon = this.querySelector(
      ".question-dropdown__item__icon .bell-crossed"
    );
